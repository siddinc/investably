...
def get_funds():
    url1 = 'http://api.stockfluence.com/fund/type/losers?apikey=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
    losers = requests.get(url1).json()

    url2 = 'http://api.stockfluence.com/fund/type/gainers?apikey=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
    winners = requests.get(url2).json()

    url3 = 'http://api.stockfluence.com/fund/type/popular?apikey=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
    populars = requests.get(url3).json()

    for loser in losers:
        url4 = 'http://api.stockfluence.com/fund/{}?apikey=xxxxxxxxxxxxxxxxxxxxxxxxxxxx'.format(
            loser["symbol"])
